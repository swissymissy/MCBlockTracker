...
def main():
    ...
    tk.Label(window, text="Select an exported file from minecraft").grid(column=0,row=0)
    tk.Button(window, text="Browse file", command=browse_file).grid(column=0,row=2)
